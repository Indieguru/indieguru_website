      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/about" className="text-gray-500 hover:text-indigo-700 transition-colors duration-200 flex items-center">
                  <span className="bg-gray-200 w-1 h-1 rounded-full mr-2"></span>
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/services" className="text-gray-500 hover:text-indigo-700 transition-colors duration-200 flex items-center">
                  <span className="bg-gray-200 w-1 h-1 rounded-full mr-2"></span>
                  Services
                </Link>
              </li>
              <li>
                <Link to="/experts" className="text-gray-500 hover:text-indigo-700 transition-colors duration-200 flex items-center">
                  <span className="bg-gray-200 w-1 h-1 rounded-full mr-2"></span>
                  Meet the Experts
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/faq" className="text-gray-500 hover:text-indigo-700 transition-colors duration-200 flex items-center">
                  <span className="bg-gray-200 w-1 h-1 rounded-full mr-2"></span>
                  FAQ
                </Link>
              </li>
              <li>
                <Link to="/support" className="text-gray-500 hover:text-indigo-700 transition-colors duration-200 flex items-center">
                  <span className="bg-gray-200 w-1 h-1 rounded-full mr-2"></span>
                  Support
                </Link>
              </li>
              <li>
                <Link to="/careers" className="text-gray-500 hover:text-indigo-700 transition-colors duration-200 flex items-center">
                  <span className="bg-gray-200 w-1 h-1 rounded-full mr-2"></span>
                  Careers
                </Link>
              </li>
              <li>
                <Link to="/testimonials" className="text-gray-500 hover:text-indigo-700 transition-colors duration-200 flex items-center">
                  <span className="bg-gray-200 w-1 h-1 rounded-full mr-2"></span>
                  Testimonials
                </Link>
              </li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <p className="text-gray-500">info@indieguru.com</p>
              </div>
              <div className="flex items-center">
                <Phone className="w-4 h-4 mr-3 text-indigo-600" />
                <p className="text-gray-500">555-567-8901</p>
              </div>
              <div className="flex items-center">
        ...
        {/* <div className="mt-12 border-t border-blue-200 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex w-full md:w-auto">
              ...
              />
              <button className="bg-blue-800 hover:bg-blue-700 text-white px-4 py-2 rounded-r transition-colors duration-200">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/privacy" className="hover:text-indigo-700 transition-colors duration-200">
              Privacy Policy
            </Link>
            <Link to="/terms" className="hover:text-indigo-700 transition-colors duration-200">
              Terms of Service
            </Link>
            <Link to="/cookies" className="hover:text-indigo-700 transition-colors duration-200">
              Cookie Policy
            </Link>
          </div>
        </div>
