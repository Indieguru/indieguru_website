                ...
                <div className="max-w-4xl mx-auto">
                  ...
                  <div className="flex justify-between items-center mb-8">
                    <div>
                      ...
                      {step === 2 && (
                        <p className="text-gray-600 mt-1">From {selectedIndustry.name}</p>
                      )}
                    </div>
                  ...
                  <div className="flex justify-center mb-8">
                    <div className="flex items-center space-x-2">
                      <div className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${step === 1 ? 'bg-blue-600 scale-125' : 'bg-gray-200'}`} />
                      <div className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${step === 2 ? 'bg-blue-600 scale-125' : 'bg-gray-200'}`} />
                    </div>
                  </div>
